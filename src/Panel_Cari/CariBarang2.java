 ...
 * @author user
 */
public class CariBarang2 extends javax.swing.JFrame {

    /**
     * Creates new form CariBarang2
     */
    public CariBarang2() {
        initComponents();
        showTable();
...
public void showTable(){
    ...
    private void tbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMouseClicked
        ...
        BarangMasuk.ID.setText(id);
        BarangMasuk.Nama.setText(nama);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariBarang2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
